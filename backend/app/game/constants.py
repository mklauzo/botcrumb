...
ATTACK_INTERVAL_TICKS = 15  # 1 attack every 3 seconds at 5 ticks/sec
...
ATTACKER_QUEEN_VISION = 175.0   # radius at which attacker can spot an enemy queen
PALACE_BUILD_THRESHOLD = 5      # min energy to spend on palace bricks
...
UNIT_STATS = {
    ...
    "attacker": {"speed": 12.0, "vision": 80.0, "hp": 3,  "cost": 2, "accuracy": 0.70, "attack_range": 3.0},
